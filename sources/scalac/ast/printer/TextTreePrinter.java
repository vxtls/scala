...
public class TextTreePrinter implements TreePrinter {
    ...
    public TreePrinter print(Tree tree) {
        if (tree instanceof Tree.Bad) {
            ...
            printArray(block.stats, TXT_BLOCK_BEGIN, TXT_SEMICOLON, TXT_BLOCK_SEP);
            indent();
            printNewLine();
            print(block.expr);
            undent();
            ...
            if (Global.instance.debug || select.qualifier.symbol() == null || !select.qualifier.symbol().isRoot()) {
