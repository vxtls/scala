    ...
    private final GenTransformer treeTransformer = new GenTransformer(global) {
        ...
        public Tree transform(Tree tree) {
            ...
            if (tree instanceof Tree.If) {
                ...
                return global.make.If(tree.pos, ifTree.cond, thenp, elsep).setType(type);
            }
            if (tree instanceof Tree.Switch) {
                ...
                return global.make.Switch(tree.pos, switchTree.test, switchTree.tags, bodies, otherwise).setType(type);
            }
