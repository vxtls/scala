...
public class AddConstructors extends GenTransformer {
	...
	if (tree instanceof Tree.ClassDef) {
	    ...
	    return gen.ClassDef(clasz, transform(newBody));
            ...
            return gen.New(transform(newTree.templ.parents[0], true));
            ...
            if (!inNew && fun.symbol().isConstructor() &&
                fun.symbol().constructorClass().isClass())
            ...
            if (symbol.isConstructor()) {
                if (symbol.constructorClass().isClass()) {
