...
public class GenJVM {
    ...
    protected final Symbol SCALA_CLONEABLE_CONSTR;
    ...
    public GenJVM(Global global) {
        ...
        SCALA_CLONEABLE_CONSTR =
            defs.getClass("scala.cloneable").primaryConstructor();
    ...
    protected Tree[] extractPrimitiveArgs(Tree.Apply call) {
        if (call.fun instanceof Tree.Select) {
    ...
    protected Context enterClass(Context ctx, Symbol cSym) {
        ...
        boolean cloneable =
            global.getAttrArguments(cSym, SCALA_CLONEABLE_CONSTR) != null;
        ...
        String[] interfaceNames =
            new String[baseTps.length - offset
                       + (serializable ? 1 : 0)
                       + (cloneable ? 1 : 0)];
