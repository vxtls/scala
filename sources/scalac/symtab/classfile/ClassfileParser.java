...
public class ClassfileParser implements ClassfileConstants {
    ...
    private void patchResultOrExceptionClassInfo() {
        ...
        Symbol tryBlock = c.dualClass().lookup(Name.fromString("tryBlock"));
    ...
    private void patchNativeLoopClassInfo() {
        Definitions definitions = global.definitions;
        Symbol loopWhile = c.dualClass().lookup(Name.fromString("loopWhile"));
    ...
    private void patchMatchErrorClassInfo() {
        Definitions definitions = global.definitions;
        Symbol fail = c.dualClass().lookup(Names.fail);
        if (fail != Symbol.NONE) {
        ...
        Symbol report = c.dualClass().lookup(Names.report);
