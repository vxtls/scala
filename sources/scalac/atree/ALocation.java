...
public class ALocation {
    ...
    public static final class Field extends ALocation {
        ...
        public Field(ACode object, Symbol field, boolean isStatic) {
            this.object = object;
            this.field = field;
    ...
    public static final class Local extends ALocation {
        ...
        public Local(Symbol local, boolean isArgument) {
            this.local = local;
    ...
    public static final class ArrayItem extends ALocation {
        ...
        public ArrayItem(ACode array, ACode index) {
            this.array = array;
            this.index = index;
        }
    }
