...
public class ATreePrinter {
    ...
    public ATreePrinter printConstant(AConstant constant) {
        ...
        } else if (constant instanceof AConstant.SymbolNameValue) {
            return print('\"').print(SourceRepresentation.escape(((AConstant.SymbolNameValue) constant).value.name.toString())).print('\"');
